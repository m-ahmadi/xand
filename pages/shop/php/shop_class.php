...
class Shop {
	...
	public static function main_page_for($product) {
		...
		$html .= get_all_ajax_scripts_from_path($path);
	...
	public static function search($arr) {
		...
		$html .= get_all_ajax_scripts_from_path('../../js/');
		echo $html;
	}
	...
	private static function create_thumbnail($product) {
		...
		$html .= 		'<a href="../product/product.php?id='. $product->$column .'&amp;p_cat='. $product->p_cat .'" class="wrapper_link">';
		$html .= 			'<img src="../product/'. $product->img_brand .'" class="brand_img"/>';

		if ($product->p_cat == 'cpu') {
			$html .= 		'<img src="../product/'. $product->img_generation .'" class="generation_img"/>';
		} else if ($product->p_cat == 'motherboard') {
			$html .= 		'<img src="../product/'. $product->img_chipset .'" class="chipset_img"/>';
		} 
		
		$html .= 			'<img src="../product/'. $product->img_1 .'" class="product_img"/>';
		$html .= 		'</a>';
		$html .= 	'</div>';
