...
p.prototype.ShopingCart = (function() {
	...
	function getShopingCart() {
		...
		if (typeof cookies['SC'] !== 'undefined') {
			if (cookies.SC.length > 0) {
				...
				<table>\
				<tr>\
				<td class="tac">'+naam+'</td><td class="tal">'+gheymat+'</td><td class="tal" colspan="2">'+hazf+'</td>\
				</tr>'
				+ this.getProduct() + '\
				<tr>\
					<td>&nbsp;</td>\
				...
				<tr>\
					<td class="tac">'+jamkol+'</td><td class="tal fwb green">'+ this.calculateTotal(this.toSumArray) +'</td><td colspan="2">'+tooman+'&nbsp;</td>\
				</tr>\
				</table>\
	...
	function getSCartButton() {
		...
		if (typeof cookies['SC'] !== 'undefined') {
			if (cookies.SC.length !== 0) {
				ready = '<span id="span_item">'+mored+'</span><span id="span_num">'+ this.toSumArray.length; +'</span>';
			} else {
